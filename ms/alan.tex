...
significant decrease in LMA in response to ALAN in \emph{Colocasia
gigantea}, a shade species, but not in \emph{Melastoma candidum}, a sun
species. This suggests that ALAN may have more pronounced effects on
shade species, which could be due to their greater sensitivity to
...
resource. The presence of ALAN is known to attract a higher density of
insects, many of which may die due to collision, overheating,
dehydration, or predation {[}ref{]}. The decomposition of these deceased
insects could lead to considerable enrichment of soil nutrients,
particularly nitrogen (N) and phosphorus (P) {[}ref{]}, which are
fundamental to plant growth. (should we add rough estimate of the amount
of dead insects and nutrients here?) Although the precise quantity of
...
rather than structural tissue, leading to a decrease in LMA {[}ref{]}.
Additionally, increased soil nutrient availability, particularly
...
On the other hand, we did not find any significant effects of ALAN on
the LMA of \emph{M. candidum}. This could be due to the species'
inherent tolerance to high light conditions, meaning that the additional
light provided by ALAN may not be sufficient to trigger significant
physiological changes. Moreover, sun species like \emph{M. candidum} are
often characterized by high LMA values due to their adaptations to high
light environments, which may limit the potential for further reductions
in LMA under ALAN.

Although it had been demonstrated that LMA increases with insolation
(\protect\hyperlink{ref-Ackerly2002}{Ackerly et al. 2002},
...
would influence the physiological processes of the understory by
multi-approach both aboveground and underground. For the aboveground
part, artificial light at night change the light environments of plants,
including light duration, light intensity and light spectral quality.
Artificial light at night might indirectly change soil nutrient
conditions for the underground part by attracting insects, especially as
an important nitrogen supplement. In this study, the LMA value of the
understory showed a negative relationship with the combined effects of
...
could not confirm that the difference in the soil nutrients was due to
artificial light at night, for soil nutrients were lost throughout
rubber plant forest because of precipitation, terrain and rubber
tapping, although artificial light at night, to some extent retarded the
loss of soil nutrients in our experiment place. Furthermore, the results
of understory response could vary according to the species specificity
(sun species showed no significance in our study) and artificial light
...
Research showed that plants' biomass would increase under artificial
light through controlling experiments
(\protect\hyperlink{ref-Speisser2021a}{Speißer et al. 2021}). However,
our study showed that the allocation of the changing part of biomass
could be channelled into mixed results. Controlling experiments probably
tend to underestimate the species interaction and unpredictable
...
adequate tests of the influence of artificial light at night on the
understory will entail more experimental work under field conditions. In
future work, diverse artificial light resources in light spectral
quality and light intensity and more understory groups will be needed to
simulate the comprehensive effects of artificial light from plant
physiology to plant community. In conclusion, the general pattern of
understory species responding to artificial light at night remains
unknown. Our study showed that the LMA value of some understory species
would decrease with artificial light at night. This negative effect
could indicate that increments of artificial light at night might bring
about a physiological suppression to those understory plants, which
applied implications for environmental management and urban ecological
planning.
