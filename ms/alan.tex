...
(\protect\hyperlink{ref-Martin2020}{\textbf{Martin2020?}}) and LMA
usually varies more among species than within species
...
\caption{\label{fig-alan}The distribution of individuals around the
ALAN. The relative geographic location of individuals (points) around
the artificial light (0,0) of two experimental species (\emph{C.
gigantea} and \emph{M. candidum}). Color represents the LMA value.}
...
\caption{The illustration of experimental setup. Photographs of the
experimental plots in daylight and at night (A and B).}
