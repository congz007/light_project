...
\emph{M. candidum} when exposed to ALAN. The exact LMA values within a
species not only depend on local environmental conditions but also the
phenotypic plasticity (\protect\hyperlink{ref-Fajardo2016}{Fajardo and
Siefert 2016}). Previous study showed there were significant sun-shade
differences in leaf mass per area (LMA)
(\protect\hyperlink{ref-Martin2020}{Martin et al. 2020}) and LMA usually
varies more among species than within species
(\protect\hyperlink{ref-Poorter2009a}{Poorter et al. 2009},
\protect\hyperlink{ref-Osnas2018}{Osnas et al. 2018}). The limited
variation within the sun species \emph{M. candidum} in leaf mass per
area (LMA) could be a possible explanation for the result. This result
also parallelled with the infrequent variability in soil conditions
within the plot, which is situated on a slope with relatively high
canopy openness. Previous studies showed that the intensity of rainfall,
gradient of the slope, and length of the slope can affect water erosion
and the loss of nutrients such as N and P in surface runoff
(\protect\hyperlink{ref-Zhao2013}{Zhao et al. 2013},
\protect\hyperlink{ref-Yi2018}{Yi et al. 2018},
\protect\hyperlink{ref-Bai2020}{Bai et al. 2020}). Thus, the soil within
this plot might suffer a more substantial loss of nutrients in surface
runoff in comparison to the other plot.
...
\leavevmode\vadjust pre{\hypertarget{ref-Martin2020}{}}%
Martin, R. E., G. P. Asner, L. P. Bentley, A. Shenkin, N. Salinas, K. Q.
Huaypar, M. M. Pillco, F. D. Ccori Álvarez, B. J. Enquist, S. Diaz, and
Y. Malhi. 2020. Covariance of {Sun} and {Shade Leaf Traits Along} a
{Tropical Forest Elevation Gradient}. Frontiers in Plant Science 10.
...
\caption{\label{fig-alan}The illustration of experimental setup.
Photographs of the experimental plots in daylight and at night (A and
B).}
...
{\centering \includegraphics{/home/cong/coding/light_project/figs/lma_map.pdf}

}

\caption{\label{fig-LMA}The distribution of individuals around the ALAN.
The relative geographic location of individuals (points) around the
artificial light (0,0) of two experimental species (\emph{C. gigantea}
and \emph{M. candidum}). Color represents the LMA value.}
...
\includegraphics{/home/cong/coding/light_project/figs/Table1.pdf}
