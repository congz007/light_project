...
\begin{document}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, interior hidden, frame hidden, enhanced, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
...
representing shade tolerant speceis, and \emph{Melastoma candidum},
...
have multifaceted and species dependency impacts on the understory
ecosystem.
...
subjects of this experiment, each representing sun and shade tolerant
speceis, to discern differences in their responses to ALAN. Our
...
Botanical Garden (XTBG), China, in rubber tree forests (N21°54'
...
(Fig.~\ref{fig-alan}). The light intensity of LED lights vertically
...
within 5 m (6 lux) according to the density of the bush. The LED system
...
away from it. Essential criteria also included the species being part of
...
gigantea}, representing shade tolerant speceis, and \emph{Melastoma
...
leaf on species \emph{M. candidum}, and three to five leaves, then seven
...
was conducted in two selected plots. We took three replicates at the
...
significant decrease in LMA in response to ALAN in shade tolerant
speceis \emph{Colocasia gigantea}, but not in light demanding species
...
receive stronger sunlight than shade tolerant speceis, which might
...
for shade tolerant speceis. Although many studies have explored ITV
...
species and shade tolerant speceis. Additionally, the less pronounced
...
\emph{M. candidum}. ALAN's attraction to insects might be spatially
dependent, which leads to certain locations attracting fewer insects and
consequently experiencing a diminished soil fertilization effect. The
