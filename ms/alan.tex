...
On the other hand, the LMA of \emph{M. candidum} did not show any
significant change under the effect of ALAN. The potential explanation
for the observed result may be the limited variation within the sun
species \emph{M. candidum} in LMA. The amounts of intraspecific
variability (ITV) might be lower for sun species because sun species
typically inhabit relatively stable and predictable environments with
consistent sunlight exposure which may result in lower ITV. Although
many studies have explored ITV across different functional groups, such
as herbs versus trees (\protect\hyperlink{ref-Siefert2015}{Siefert et
al. 2015}), there needs to be more research into the ITV differences
between sun species and shade species. Additionally, no significant
change in LMA in this plot could be attributed to the soil nutrients
remaining stable. There was a comparable decrease in soil nutrient
observed both in the area under ALAN and 10m away from ALAN. The
probable explanation for this is that the area under ALAN was situated
on a slope with relatively high canopy openness. Because factors such as
rainfall intensity, slope gradient, and slope length have an impact on
water erosion and the depletion of nutrients like nitrogen (N) and
phosphorus (P) in surface runoff (\protect\hyperlink{ref-Zhao2013}{Zhao
et al. 2013}, \protect\hyperlink{ref-Yi2018}{Yi et al. 2018},
