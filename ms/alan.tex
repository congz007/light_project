...
\emph{M. candidum} when exposed to ALAN. This is likely due to factors
such as slope, precipitation, and human activities such as trampling.
Previous studies have shown that the intensity of rainfall, gradient of
the slope, and length of the slope can affect water erosion and the loss
of nutrients such as N and P in surface runoff
...
in LMA of \emph{M. candidum}, as LMA usually varies more among species
than within species (\protect\hyperlink{ref-Poorter2009a}{Poorter et al.
2009}, \protect\hyperlink{ref-Fajardo2016}{Fajardo and Siefert 2016},
\protect\hyperlink{ref-Osnas2018}{Osnas et al. 2018}). (Xiaoyang: Maybe
discuss why sun species is not significant)
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{table }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\FunctionTok{here}\NormalTok{(}\StringTok{"data/table.csv"}\NormalTok{))}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{sp) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kbl}\NormalTok{(}\AttributeTok{caption =} \StringTok{"Coefficients table"}\NormalTok{,}\AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Parameters"}\NormalTok{, }\StringTok{"Mean value"}\NormalTok{, }\StringTok{"95\% CI"}\NormalTok{ ),}\AttributeTok{booktabs =}\NormalTok{ T)}\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{column\_spec}\NormalTok{(}\DecValTok{3}\NormalTok{, }\AttributeTok{bold =} \FunctionTok{c}\NormalTok{(F,F,F,T,T,F)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{pack\_rows}\NormalTok{(}\StringTok{"Melastoma candidum"}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{,}\AttributeTok{italic =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{pack\_rows}\NormalTok{(}\StringTok{"Colocasia\_gigantea"}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{6}\NormalTok{,}\AttributeTok{italic =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{table}
\end{Highlighting}
\end{Shaded}
