...
\tightlist
\item
  Why Meslastoma did not show significant results? 坡度 林冠开度 冲刷
\item
  Are there any soil fertilization in the Meslastoma plot? fertilization
  is forbided in XTBG,
\end{itemize}

On the other hand, no significant fluctuation in leaf mass per area
(LMA) in \emph{Melastoma candidum}
