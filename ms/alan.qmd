...
All statistical analyses were conducted in R version 4.x [@RCoreTeam2022] using the R package *targets* version x.x for workflow management [@Landau2021].
...
The experimental results might also be attributed to the limited intraspecific variation in LMA of *M. candidum*, as LMA usually varies more among species than within species [@Poorter2009a; @Fajardo2016; @Osnas2018].
