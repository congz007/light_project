...
On the other hand, no significant fluctuation was found in leaf mass per area (LMA) in *M. candidum* under artificial light at night (ALAN) probably due to low canopy openness, slope and human interference like tread.
Slope causing surface runoff and human trampling might make soil homogenisation [@Kissling2009; @Yi2018; @Yang2018; @Bai2020], which dilute the indirect impact of artificial light at night (ALAN).
Thus, LMA in *M. candidum* varies little in respond to low frequency variability in soil conditions.
It should also be noted that the experimental results may also be influenced by the degree of intraspecific variation in LMA, which may overwhelm or counteract part of the environmental effects[@Poorter2009a; @Osnas2018].
Currently, there is no existing database for LMAs belonging to the *Colocasia* or *Melastoma* genera, thus preventing us from comparing our data with them.
