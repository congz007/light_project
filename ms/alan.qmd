...
The exact LMA values within a species not only depend on genetic variation but also the phenotypic plasticity [@Fajardo2016].
...
This result also parallelled with the infrequent variability in soil conditions within the plot.
...
The soil within this plot might suffer a more substantial loss of nutrients in surface runoff in comparison to the other plot because this plot is situated on a slope with relatively high canopy openness.
