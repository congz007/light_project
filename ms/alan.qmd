...
We selected two species: *Colocasia gigantea*, representing shade torelance speceis, and *Melastoma candidum*, representing light demanding species.
We measured canopy openness, LMA, soil nutrients, and individual distance away from light resource.
...
These results suggest that ALAN might have multifaceted and species dependency impacts on the understory ecosystem.
...
We selected two species as subjects of this experiment, each representing sun and shade torelance speceis, to discern differences in their responses to ALAN.
...
ALAN field experiments were located within the Xishuangbanna Tropical Botanical Garden (XTBG), China, in rubber tree forests (N21°54' E101°16') where we set 5 plots and selected two plots for this experiment based on the natural distribution of the target plant species.
...
The light intensity of LED lights vertically decreased from 300 lux at the luminous place to 100 lux at a height of 1.3 metres to 12 lux at the ground, and horizontally mainly concentrated within 5 m (6 lux) according to the density of the bush.
...
We considered the understory conditions to select species, ensuring that at least 15 mature individuals present from the light source to 10 m away from it.
...
As a result, we chose two species, each from a different plot for our study: *Colocasia gigantea*, representing shade torelance speceis, and *Melastoma candidum* representing light demanding species.
...
For leaf mass per area (LMA), we used 1.0‐cm‐diameter leaf disc punched from leaf avoiding vein and leaf margin instead of whole-leaf to calculate individual mean LMA value [@Maenpuen2022].
We chose five healthy leaves, then five leaf discs, each leaf on species *M. candidum*, and three to five leaves, then seven leaf discs on species *C. gigantea*.
...
Detailed analysis of soil nutrients was conducted in two selected plots.
...
We observed a significant decrease in LMA in response to ALAN in shade torelance speceis *Colocasia gigantea*, but not in light demanding species *Melastoma candidum*.
...
light demanding species receive stronger sunlight than shade torelance speceis, which might result in the small effect of ALAN on their LMA.
Because the effect of daylight was not significant either, intraspecific trait variability (ITV) itself for light demanding species may inherently be smaller than for shade torelance speceis.
Although many studies have explored ITV across different functional groups, such as herbs versus trees [@Siefert2015], there needs to be more research into the ITV differences between light demanding species and shade torelance speceis.
...
ALAN's attraction to insects might be spatially dependent,  which leads to certain locations attracting fewer insects and consequently experiencing a diminished soil fertilization effect.
