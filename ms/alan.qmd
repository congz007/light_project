...
However, these differences were less pronounced in the plot containing *M. candidum*.
<!-- put values for the other site -->
...
We observed a significant decrease in LMA in response to ALAN in shade species *Colocasia gigantea*, but not in sub species *Melastoma candidum*.

We observed the apparent decline in soil nutrient content from 2019 to 2022.
This trend could be largely attributed to the nutrient absorption characteristics of the rubber trees dominating our study location.
...
ALAN is known to attract insects, which, upon death due to collision, overheating, or predation, could contribute additional nutrient inputs into the soil, especially N and P.
...
The significant decrease in leaf mass per area (LMA) in *C. gigantea* under artificial light at night (ALAN) could be predominantly driven by indirect effects mediated through changes in soil nutrient availability rather than direct effects of ALAN acting as a light resource.
The presence of ALAN is known to attract a higher density of insects, many of which may die due to collision, overheating, dehydration, or predation [ref].
The decomposition of these deceased insects could lead to considerable enrichment of soil nutrients, particularly nitrogen (N) and phosphorus (P) [ref], which are fundamental to plant growth.
(should we add rough estimate of the amount of dead insects and nutrients here?)
...
The enhanced nutrient availability may enable *C. gigantea* to allocate more resources to rapid leaf growth rather than structural tissue, leading to a decrease in LMA [ref].
...
The decrease in leaf mass per area (LMA) in response to ALAN in C. gigantea supports previous findings of a controlled experiment that showed plant biomass could increase under ALAN [@Speisser2021a].
