...
On the other hand, no significant variation in LMA was found in *M. candidum* under ALAN.
...
The amounts of intraspecific variability (ITV)  might be lower for sun species because sun species typically inhabit relatively stable and predictable environments with consistent sunlight exposure which may result in lower ITV. 
Although many studies have explored ITV across different functional groups, such as herbs versus trees [@Siefert2015], there needs to be more research into the ITV differences between sun species and shade species.
Additionally, no significant change in LMA in this plot could be attributed to the soil nutrients remaining stable.
There was a comparable decrease in soil nutrient observed both in the area under ALAN and 10m away from ALAN.
The probable explanation for this is that the area under ALAN was situated on a slope with relatively high canopy openness.
Because factors such as rainfall intensity, slope gradient, and slope length have an impact on water erosion and the depletion of nutrients like nitrogen (N) and phosphorus (P) in surface runoff [@Zhao2013; @Yi2018; @Bai2020].

The probable explanation for this is that the area under artificial light at night (ALAN) was situated on a slope with a relatively high level of canopy openness. Factors such as rainfall intensity, slope gradient, and slope length influence water erosion and the loss of nutrients such as nitrogen (N) and phosphorus (P) through surface runoff.
