...
%DIF DEL /tmp/EKQJhnlwyo/latexdiff-vc-1bae014/alan.tex   Wed Jul 12 15:48:36 2023
%DIF ADD alan.tex                                        Thu Jul 20 10:58:50 2023
...
\begin{document}
\ifdefined\Shaded\DIFdelbegin %DIFDELCMD < \renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, interior hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, breakable]}{\end{tcolorbox}}%%%
\DIFdelend \DIFaddbegin \renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, sharp corners, enhanced, boxrule=0pt, frame hidden, interior hidden]}{\end{tcolorbox}}\DIFaddend \fi
...
representing \DIFdelbegin \DIFdel{shade }\DIFdelend \DIFaddbegin \DIFadd{shade-torelant }\DIFaddend species, and \emph{Melastoma candidum},
...
have complex and \DIFdelbegin \DIFdel{multifaceted }\DIFdelend \DIFaddbegin \DIFadd{species-specific }\DIFaddend impacts on the understory ecosystem.
...
2020}, \protect\hyperlink{ref-Boyes2021}{Boyes et al. 2021}\DIFaddbegin \DIFadd{,
}\protect\hyperlink{ref-Yang2022}{Yang and Nakamura 2022}\DIFaddend ). Many studies
...
experiments with and without weak ALAN (28 \DIFdelbegin \DIFdel{lx}\DIFdelend \DIFaddbegin \DIFadd{lux}\DIFaddend : within the range of
...
\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Riva2016}{Riva et al. 2016}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Katabuchi2012}{Katabuchi et al. 2012}\DIFadd{,
}\protect\hyperlink{ref-Riva2016}{de la Riva et al. 2016}\DIFaddend ), and those
...
tropical rubber plant forest in south China. \DIFaddbegin \DIFadd{A previous study conducted
at the same site, with the same experimental setup, demonstrated that
ALAN attracts ants (}\protect\hyperlink{ref-Yang2022}{Yang and Nakamura
2022}\DIFadd{). }\DIFaddend We selected two \DIFaddbegin \DIFadd{understory }\DIFaddend species as subjects of this
experiment, each representing \DIFdelbegin \DIFdel{sun and shade }\DIFdelend \DIFaddbegin \DIFadd{light-demanding and shade-torelant
}\DIFaddend species, to discern differences in their responses to ALAN. Our
...
(Fig.~\ref{fig-alan}). The LED system \DIFdelbegin \DIFdel{included six components. A metal box with an opening served as a
rainproof protector. This box was attached to a tree around 1.2m from the ground}\DIFdelend \DIFaddbegin \DIFadd{was programmed to function
automatically from 8 pm to 5 am daily}\DIFaddend . A rechargeable lithium battery
(\DIFdelbegin \DIFdel{12v}\DIFdelend \DIFaddbegin \DIFadd{12V}\DIFaddend /30Ah) and an electric timer controlled the timing and duration of
the LED operation at night. \DIFdelbegin \DIFdel{An electric wire connected the battery and LED, hanging }\DIFdelend \DIFaddbegin \DIFadd{The battery and LEDs were connected by
electric wire and hung }\DIFaddend from a tree branch with a lampshade approximately
2 m from the ground. The \DIFdelbegin \DIFdel{LED
system was programmed to function automatically from 8 pm to 5 am daily}\DIFdelend \DIFaddbegin \DIFadd{light intensity of LED lights at the light
...
was almost undetectable at 0 lux beyond 10 m}\DIFaddend . The experiment was set up
...
m away from it}\DIFaddend . Essential criteria also included the species being part
...
two species, each from a different plot\DIFaddbegin \DIFadd{, }\DIFaddend for our study: \emph{Colocasia
gigantea}, representing \DIFdelbegin \DIFdel{shade }\DIFdelend \DIFaddbegin \DIFadd{shade-torelant }\DIFaddend species, and \emph{Melastoma
...
\DIFaddend For leaf mass per area (LMA), we used \DIFaddbegin \DIFadd{a }\DIFaddend 1.0‐cm‐diameter \DIFdelbegin \DIFdel{leaf disc punched from leaf
avoiding vein and leaf margin instead
of }\DIFdelend \DIFaddbegin \DIFadd{puncher instead
of using }\DIFaddend whole-leaf \DIFdelbegin \DIFdel{to calculate
individual mean LMA value }\DIFdelend \DIFaddbegin \DIFadd{LMA values, avoiding veins and leaf margins
}\DIFaddend (\protect\hyperlink{ref-Maenpuen2022}{Maenpuen et al. 2022}). We chose
five healthy leaves \DIFdelbegin \DIFdel{, then }\DIFdelend \DIFaddbegin \DIFadd{from each individual }\emph{\DIFadd{M. candidum}} \DIFadd{plant, and
between three to five healthy leaves from each individual }\emph{\DIFadd{C.
gigantea}} \DIFadd{plant. We then punched }\DIFaddend five leaf discs \DIFdelbegin \DIFdel{, each leaf on species }\DIFdelend \DIFaddbegin \DIFadd{from each }\DIFaddend \emph{M.
candidum} \DIFdelbegin \DIFdel{, and round five leaves, then }\DIFdelend \DIFaddbegin \DIFadd{leaf, and }\DIFaddend seven leaf discs \DIFdelbegin \DIFdel{on species }\DIFdelend \DIFaddbegin \DIFadd{from each leaf of }\DIFaddend \emph{C.
gigantea}.
...
was conducted in the two selected plots. }\DIFaddend We took three replicates at the
place under ALAN and \DIFdelbegin \DIFdel{10m }\DIFdelend \DIFaddbegin \DIFadd{10 m }\DIFaddend away from ALAN separately from each plot.
After sampling, the soils were air-dried at room temperature for one
week, then sieved through 0.85\DIFdelbegin \DIFdel{mm }\DIFdelend \DIFaddbegin \DIFadd{-mm }\DIFaddend and 0.15\DIFdelbegin \DIFdel{mm }\DIFdelend \DIFaddbegin \DIFadd{-mm }\DIFaddend mesh finally used for
...
Thermo Fisher Scientific, USA). \DIFdelbegin \DIFdel{Then we }\DIFdelend \DIFaddbegin \DIFadd{We then }\DIFaddend calculated the relative
...
and without ALAN's effect (sampled \DIFdelbegin \DIFdel{10m }\DIFdelend \DIFaddbegin \DIFadd{10 m }\DIFaddend away from ALAN).

\emph{Data Analysis}

To analyze the effects of ALAN, daylight \DIFdelbegin \DIFdel{'s effect, }\DIFdelend and their interaction on
...
\DIFdelbegin \DIFdel{both the accumulation of insects and }\DIFdelend the intensity of ALAN diminish non-linearly with distance. Hereafter, we
...
significant decrease in LMA in response to ALAN in \DIFdelbegin \DIFdel{shade }\DIFdelend \DIFaddbegin \DIFadd{shade-torelant
}\DIFaddend species \emph{Colocasia gigantea}, but not in \DIFdelbegin \DIFdel{sun }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species
...
receive stronger sunlight than \DIFdelbegin \DIFdel{shade }\DIFdelend \DIFaddbegin \DIFadd{shade-torelant }\DIFaddend species, which might
...
for \DIFdelbegin \DIFdel{shade }\DIFdelend \DIFaddbegin \DIFadd{shade-torelant }\DIFaddend species. Although many studies have explored ITV
...
to be more research into the ITV differences between \DIFdelbegin \DIFdel{sun species and shade }\DIFdelend \DIFaddbegin \DIFadd{light-demanding
species and shade-torelant }\DIFaddend species. Additionally, the less pronounced
...
\protect\hyperlink{ref-Bai2020}{Bai et al. 2020}). \DIFaddbegin \DIFadd{Alternatively, ALAN's
...
\DIFdelbegin %DIFDELCMD < \href{https://doi.org/10.1007/s004420100805}{Leaf size, specific leaf
%DIFDELCMD < area and microhabitat distribution of chaparral woody plants:
%DIFDELCMD < Contrasting patterns in species level and community level analyses}%%%
\DIFdelend \DIFaddbegin \href{https://doi.org/10.1007/s004420100805}{Leaf size, specific leaf
area and microhabitat distribution of chaparral woody plants:
{Contrasting} patterns in species level and community level analyses}\DIFaddend .
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Riva2016}{}}%DIF > 
\DIFadd{de la Riva, E. G., M. Olmo, H. Poorter, J. L. Ubera, and R. Villar.
...
Availability Gradient}}\DIFadd{. PLOS ONE 11:e0148788.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Fagan2002}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Falchi2016a}{}}%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Falcon2020}{}}%DIF > 
...
\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Gaston2013}{}}%
Gaston, K. J., J. Bennie, T. W. Davies, and J. Hopkins. 2013.
\DIFdelbegin %DIFDELCMD < \href{https://doi.org/10.1111/brv.12036}{The ecological impacts of
%DIFDELCMD < nighttime light pollution: A mechanistic appraisal}%%%
\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/brv.12036}{The ecological impacts of
nighttime light pollution: {A} mechanistic appraisal}\DIFaddend . Biological
Reviews 88:912--927.
...
Katabuchi, M. 2015.
\DIFdelbegin %DIFDELCMD < \href{https://doi.org/10.1007/s11284-015-1307-x}{{LeafArea}: An {R}
%DIFDELCMD < package for rapid digital image analysis of leaf area}%%%
\DIFdelend \DIFaddbegin \href{https://doi.org/10.1007/s11284-015-1307-x}{{LeafArea}: {An R}
package for rapid digital image analysis of leaf area}\DIFaddend . Ecological
Research 30:1073--1077.

\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Katabuchi2012}{}}%DIF > 
\DIFadd{Katabuchi, M., H. Kurokawa, S. J. Davies, S. Tan, and T. Nakashizuka.
...
dipterocarp forest}\DIFadd{. Journal of Ecology 100:643--651.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Landau2023}{}}%
...
McKechnie. 2015. \DIFdelbegin %DIFDELCMD < \href{https://doi.org/10.1111/1365-2664.12381}{Stacking
%DIFDELCMD < the odds: Light pollution may shift the balance in an ancient
%DIFDELCMD < predator\textendash prey arms race}%%%
\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/1365-2664.12381}{Stacking
the odds: {Light} pollution may shift the balance in an ancient
{Predator}\textendash{{Prey}} arms race}\DIFaddend . Journal of Applied Ecology
52:522--531.
...
\leavevmode\vadjust pre{\DIFdelbegin %DIFDELCMD < \hypertarget{ref-Riva2016}{}}%%%
%DIF < 
\DIFdel{Riva, E. G. de la, M. Olmo, H. Poorter, J. L. Ubera, and R. Villar.
2016. }%DIFDELCMD < \href{https://doi.org/10.1371/journal.pone.0148788}{Leaf {Mass}
%DIFDELCMD < per {Area} ({LMA}) and {Its Relationship} with {Leaf Structure} and
%DIFDELCMD < {Anatomy} in 34 {Mediterranean Woody Species} along a {Water
%DIFDELCMD < Availability Gradient}}%%%
\DIFdel{. PLOS ONE 11:e0148788.
}%DIFDELCMD < 

%DIFDELCMD < \leavevmode\vadjust %%%
\DIFdel{pre}%DIFDELCMD < {%%%
\DIFdelend \hypertarget{ref-Russart2018}{}}%
...
\DIFdelbegin %DIFDELCMD < \href{https://doi.org/10.1093/jxb/erj014}{Irradiance and phenotype:
%DIFDELCMD < Comparative eco-development of sun and shade leaves in relation to
%DIFDELCMD < photosynthetic {CO2} diffusion}%%%
\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/jxb/erj014}{Irradiance and phenotype:
{Comparative} eco-development of sun and shade leaves in relation to
photosynthetic {CO2} diffusion}\DIFaddend . Journal of Experimental Botany
57:343--354.
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-Yang2022}{}}%DIF > 
\DIFadd{Yang, R., and A. Nakamura. 2022.
}\href{https://doi.org/10.17520/biods.2022067}{{Cavity-dwelling ants tend
to colonize close to artificial light.}} \DIFadd{Biodiversity Science 30.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Yi2018}{}}%
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/home/cong/coding/light_project/figs/lma_map.pngs}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/cong/coding/light_project/figs/lma_map.png}
\DIFaddendFL 
