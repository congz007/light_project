...
%DIF DEL /var/folders/ph/r5fc9nzd1j38q4j50kgwd4cw0000gn/T/eSXPblfOHL/latexdiff-vc-4ba0ffb/alan.tex   Tue Jul 18 15:22:43 2023
%DIF ADD alan.tex                                                                                    Tue Jul 18 17:24:30 2023
...
\begin{document}
\ifdefined\Shaded\DIFdelbegin %DIFDELCMD < \renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, interior hidden, frame hidden, enhanced, boxrule=0pt, sharp corners]}{\end{tcolorbox}}%%%
\DIFdelend \DIFaddbegin \renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, breakable, boxrule=0pt]}{\end{tcolorbox}}\DIFaddend \fi
...
representing \DIFdelbegin \DIFdel{shade tolerant speceis}\DIFdelend \DIFaddbegin \DIFadd{shade-torelant species}\DIFaddend , and \emph{Melastoma candidum},
representing \DIFdelbegin \DIFdel{light demanding }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species. We measured canopy openness, LMA,
...
have \DIFdelbegin \DIFdel{multifaceted and species dependency }\DIFdelend \DIFaddbegin \DIFadd{complex and species-specific }\DIFaddend impacts on the understory ecosystem.
...
\protect\DIFaddbegin \hyperlink{ref-Katabuchi2012}{Katabuchi et al. 2012}\DIFadd{,
}\protect\DIFaddend \hyperlink{ref-Riva2016}{Riva et al. 2016}), and those effects
...
subjects of this experiment, each representing sun and \DIFdelbegin \DIFdel{shade tolerant
speceis}\DIFdelend \DIFaddbegin \DIFadd{shade-torelant
species}\DIFaddend , to discern differences in their responses to ALAN. Our
...
Botanical Garden (XTBG), China, in \DIFdelbegin \DIFdel{rubber tree forests }\DIFdelend \DIFaddbegin \DIFadd{a rubber tree forest }\DIFaddend (N21°54'
...
(Fig.~\ref{fig-alan}). The \DIFdelbegin \DIFdel{light intensity of LED lights vertically
...
within }\DIFdelend \DIFaddbegin \DIFadd{LED system was programmed to function
automatically from 8 pm to }\DIFaddend 5 \DIFdelbegin \DIFdel{m (6 lux) according to the density of the bush. The LED system included six components. A metal box with an opening served as a
rainproof protector. This box was attached to a tree around 1.2m from the ground}\DIFdelend \DIFaddbegin \DIFadd{am daily}\DIFaddend . A rechargeable lithium battery
...
system was programmed to function automatically from 8 pm to 5 am daily. The }\DIFdelend \DIFaddbegin \DIFadd{light intensity of LED lights at the light
sources was xxx ± xxx (mean ± SE) lux. The light intensity decreased
with distance: xxx ± xxx lux at a radius of 1 m, xxx ± xxx lux at a
radius of 2 m, and xxx ± xxx lux at a radius of 4 m. The light intensity
was almost undetectable at 0 lux beyond xxx m The }\DIFaddend experiment was set up
...
at least 15 mature individuals \DIFaddbegin \DIFadd{were }\DIFaddend present from the light source to 10
...
gigantea}, representing \DIFdelbegin \DIFdel{shade tolerant speceis}\DIFdelend \DIFaddbegin \DIFadd{shade-torelant species}\DIFaddend , and \emph{Melastoma
candidum} representing \DIFdelbegin \DIFdel{light demanding }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species.
...
}\DIFdelend \DIFaddbegin \DIFadd{puncher,
}\DIFaddend avoiding vein and leaf margin instead of \DIFaddbegin \DIFadd{using }\DIFaddend whole-leaf \DIFdelbegin \DIFdel{to calculate
individual mean }\DIFdelend LMA value
(\protect\hyperlink{ref-Maenpuen2022}{Maenpuen et al. 2022}). We chose
five healthy leaves \DIFdelbegin \DIFdel{, then five leaf discs, each leaf on species }\DIFdelend \DIFaddbegin \DIFadd{from each individual }\DIFaddend \emph{M. candidum} \DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{plant, and
between }\DIFaddend three to five \DIFdelbegin \DIFdel{leaves, then }\DIFdelend \DIFaddbegin \DIFadd{healthy leaves from each individual }\emph{\DIFadd{C.
gigantea}} \DIFadd{plant. We then punched five leaf discs from each }\emph{\DIFadd{M.
candidum}} \DIFadd{leaf, and }\DIFaddend seven leaf discs \DIFdelbegin \DIFdel{on species }\DIFdelend \DIFaddbegin \DIFadd{from each leaf of }\DIFaddend \emph{C.
gigantea}.
...
was conducted in \DIFaddbegin \DIFadd{the }\DIFaddend two selected plots. We took three replicates at the
...
then sieved through 0.85-mm and 0.15-mm mesh finally used for total N, C
...
significant decrease in LMA in response to ALAN in \DIFdelbegin \DIFdel{shade tolerant
speceis }\DIFdelend \DIFaddbegin \DIFadd{shade-torelant
species }\DIFaddend \emph{Colocasia gigantea}, but not in \DIFdelbegin \DIFdel{light demanding }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species
...
\DIFdelbegin \DIFdel{light demanding }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species \emph{M. candidum}. \DIFdelbegin \DIFdel{light demanding }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species
receive stronger sunlight than \DIFdelbegin \DIFdel{shade tolerant speceis}\DIFdelend \DIFaddbegin \DIFadd{shade-torelant species}\DIFaddend , which might
...
(ITV) itself for \DIFdelbegin \DIFdel{light demanding }\DIFdelend \DIFaddbegin \DIFadd{light-demanding }\DIFaddend species may inherently be smaller than
for \DIFdelbegin \DIFdel{shade tolerant speceis}\DIFdelend \DIFaddbegin \DIFadd{shade-torelant species}\DIFaddend . Although many studies have explored ITV
...
to be more research into the ITV differences between \DIFdelbegin \DIFdel{light demanding
species and shade tolerant speceis}\DIFdelend \DIFaddbegin \DIFadd{light-demanding
species and shade-torelant species}\DIFaddend . Additionally, the less pronounced
...
\emph{M. candidum}. \DIFdelbegin \DIFdel{ALAN's attraction to insects might be spatially
dependent, which leads to certain locations attracting fewer insects and
consequently experiencing a diminished soil fertilization effect. }\DIFdelend The ALAN treatment was set up on a slope in this
...
\leavevmode\vadjust pre{\hypertarget{ref-Falcon2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Forsburg2021}{}}%
...
2012. }\href{https://doi.org/10.1111/j.1365-2745.2011.01937.x}{\DIFadd{Soil
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/home/cong/coding/light_project/figs/merge.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/light_project/figs/merge.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/home/cong/coding/light_project/figs/lma_map.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/light_project/figs/lma_map.png}
\DIFaddendFL 
...
\DIFdelbegin %DIFDELCMD < \includegraphics[width=3.125in,height=\textheight]{/home/cong/coding/light_project/figs/Table1.png}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \includegraphics[width=3.125in,height=\textheight]{/Users/mattocci/Dropbox/Reserach/MS/light_project/figs/Table1.png}
\DIFaddend 
