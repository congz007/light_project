...
table_sp1 %>%
  kbl(caption = "Coefficients table species one") %>%column_spec(3,bold =  ifelse(test$`2.5%`*test$`97.5%`>0, "T","F"))%>% 
...
table_sp2 %>%
  kbl(caption = "Coefficients table species one") %>%column_spec(3,bold =  ifelse(test1$`2.5%`*test1$`97.5%`>0, "T","F"))%>% 
  kable_classic(full_width = F, html_font = "Cambria")
