...
Many kinds of insects orient themselves by maintaining a constant angle to light rays and are attracted by light [positive phototaxis? [@Baker1978; @Sotthibandhu1979]].
...
Since nitrogen (N) and phosphorus (P) are the nutrients most frequently limiting primary productivity in forest ecosystems (refs), dead insects killed by ALAN could be important nutrient input for soil nutrient.
Soil resources, especially N and P availability, are known to affect leaf mass per area (LAM) and leaf N and P contents (refs), and those effects are known to be opposite to the effects of light (refs) (e.g., strong light increase LMA but high N availability decrease LMA).

Here we report the results of a 2-year ALAN experiment in forest understory to simulate light pollution.
