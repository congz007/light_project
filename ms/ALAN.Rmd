...
Artificial light at night (ALAN), demonstrated a new ecological factor influences organism through multi-approach.
As yet assessing impacts of artificial light at night on understory plants doesn't get much attentions.
We evaluated whether ALAN would affect the LMA (leaf mass per area) of understory plants through a two-year field light experiment in tropical rubber plant forest in south China.
We assumed ALAN would affect understory by two pathways of directly increasing light supplement aboveground and indirectly attracting insects then changing soil nutrients underground.
...
A recent study estimated that 23% of the world's land surfaces where people live and more than 80% of the world population experience light pollution [@Falchi2016].
Although the intensity of ALAN varies several orders of magnitude from faint skyglow reflected from distant cities to direct illumination of urban and suburban vegetation [@Bennie2016], ALAN could influences behavior or physiology broad ranges of taxonomic groups including mammals, birds, reptiles, amphibians, fishes, invertebrates, and plants and could potentially alter ecosystem functions [@Rich2006].
...
Many studies have focused on how ALAN changes the behavior of animals [@Russart2018], however only a handful studies have been published on the effect of ALAN on plants [@Bennie2016; @Speisser2021a; @Liu2022].
@Speisser2021a conducted plant growth experiments with and without weak ALAN (28 lx: within the range of light intensities at ground level under street lights) and showed that ALAN increases biomass of herbaceous plants.
Their results suggest that even weak ALAN acts as a light resource for plant growth.
<!-- need to change the last sentence.  -->
...
First, ALAN might directly affect plant leaf functional traits because ALAN could work as light resources.
...
@Terashima2006 showed that the light-saturated rate of leaf photosynthesis per unit area ($P_{max}$) is highly correlated with leaf structural parameters such as leaf thickness, leaf mass per area, mesophyll surface area($S_{mes}$), and chloroplast surface area ($S_c$), and sun leaves are thicker than shade leaves exactly as the height of the palisade tissue in sun leaves is greater than that in shade leaves.
...
In plants, the physiological processes can be influenced by the intensity of artificial light at night commonly used in urban and suburban areas, as well as along highways [@Bennie2016; @Massetti2018].
ALAN has been associated with various effects on plants, such as alterations in leaf coloration, retention or abscission (in deciduous trees), bud development, flowering patterns, growth rates, competetion and defense mechanisms against pathogens.
Several studies demonstrated the impact of artificial light at night (ALAN) on certain plant circadian processes [@Sodani2021a], including enzyme activity, stomatal movement, photosynthesis, and photoperiodic movements.
Furthermore, the presence of artificial light at night (ALAN) has emerged as a novel threat to the reproductive success of plants [@Wang2022a], as it disrupts the delicate balance of plant-pollinator ecosystems [@Knop2017].
