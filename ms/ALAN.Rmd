...
Like other kinds of pollution, the presence of unwanted, inappropriate, or excessive artificial lighting konwn as light pollution [@Wikipedia2022], had given rise to a certain impact on human beings, society and ecological environment [@Falchi2011].
...
It casts effects among wild taxonomic groups both zoology and botany, from mammals, birds, reptiles and amphibians, fishes, invertebrates and plants etc [@Rich2006].
ALAN modulates the behavior of animals typically attracting insects so as an important bringer to drive insects population decline [@Boyes2021; @Owens2020].
To plants, biomass would increase responsing to ALAN and show different ratio between widely and less‐widely naturalized alien plants [@Speißer2021].
...
However, no rigorous studies have examined the effects of artificial light at night on plants in conditions close to their natural environment.

ALAN might directly affect plant leaf functional traits by changing plant light environments.
...
Actually, plants could sense light through photorecpetors which allows the plant to respond to four parameters of their light environment: light spectral quality, light intensity, light direction, and light duration [@Paik2019; @Rich2006].
...
ALAN might indirectly affect plant leaf functional traits as a potential factor to drive soil environmental conditions.
In previous study, it has been demonstrated that leaf functional traits (LFTs) such as leaf area, leaf thickness, leaf density, leaf C and leaf N:P change with soil properties like soil pH, P, Ca, Mg, K, C:N [@Hernandez-Vargas2019]. 
And nitrogen contents per unit leaf area $N_a$ increased with environmental nitrogen contents, while LMA shows different correlation decreasing with N supply [@Jullien2009; @An2008].
...
Hence, besides the direct effect from ALAN the nutrients condition of the plants should also cause our attention.
...
Then comes our another research hypothesis that ALAN would decrease LMA of plants around it indirectly as a side-effect of gathering phototaxis insects which chagnes the nutrients condition by distance.
