...
llp2 |> filter(species == "Melastoma candidum")|>
  ...
  geom_point(shape =16)+
  labs(x = "", y = "")+
  theme(strip.text = element_text(face = "italic",size = 14),legend.position = c(0.9,0.5),legend.key.size = unit(15,"pt"),legend.background = element_rect(fill= FALSE))
...
llp2 |> filter(species == "Colocasia gigantea")|>
  ...
  geom_point(shape =16)+
  labs(x = "", y = "")+
  theme(strip.text = element_text(face = "italic",size = 14),legend.position = c(0.92,0.5),legend.key.size = unit(13,"pt"),legend.background = element_rect(fill= FALSE))
